...
class MobilePayOfDebt extends StatefulWidget {
  final String? price;
  final int? id;
  final bool forCustomer;

  const MobilePayOfDebt(
      {super.key, this.price, this.id, required this.forCustomer});

  @override
  State<MobilePayOfDebt> createState() => _MobilePayOfDebtState();
}

class _MobilePayOfDebtState extends State<MobilePayOfDebt> {
  int? selectedValuee;
  int? typesId;
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          const TextWidget(txt: "Qarzini to'lash"),
                ...
                child: MobileButton(
                  ...
                  onTap: () {
                    if (widget.forCustomer) {
                      ...
                      context.read<ShowCompanyCubit>().payCompany(
                        widget.id ?? 0,
                        selectedValuee ?? 0,
                        typesId ?? 0,
                        txtComment.text,
