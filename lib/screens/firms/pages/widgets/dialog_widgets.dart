...
class CompanyDialogWidgets extends StatefulWidget {
  const CompanyDialogWidgets({super.key});

  @override
  State<CompanyDialogWidgets> createState() => _CompanyDialogWidgetsState();
}

class _CompanyDialogWidgetsState extends State<CompanyDialogWidgets> {
